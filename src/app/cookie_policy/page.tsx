    ...
    return (
        <div className="bg-slate-300 p-5 text-slate-600">
            <div className="rounded-lg bg-slate-50 p-3">
                <h1 className="px-2 py-5 text-center text-3xl font-bold">プライバシーポリシー</h1>
                <p className="p-5">
                ...
                <p className="px-5 pb-5">
                    ...
                    クッキーには、当サイトによって設定されるもの（ファーストパーティークッキー）と，当社と提携する第三者によって設定されるもの（サードパーティークッキー）があります．
                </p>

                <h1 className="my-3 border-l-4 border-solid border-l-teal-400 px-5 text-xl font-bold">2．クッキーの利用目的</h1>
                <p className="px-5 pb-5">
