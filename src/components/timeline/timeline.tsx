...
export default function Timeline() {
    return (
        <div className="relative mx-auto mt-20 flex min-h-screen max-w-2xl flex-col justify-center overflow-hidden antialiased">
                    ...
                    <div className="flex flex-col justify-center divide-y divide-slate-200 [&>*]:py-16">
                        <div className="mx-auto w-full max-w-3xl">
                            <div className="relative space-y-8 before:absolute before:inset-0 before:ml-5 before:h-full before:w-0.5 before:-translate-x-px before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent md:before:ml-[8.75rem] md:before:translate-x-0">
                                ...
                                <TimeCard date="2024-05" title="ホームページリニューアル！" body="Next.jsとReact，Tailwind CSSでホームページをリニューアル！技術スタックの更新とともにページのデザインもモダンに．"imgURL="/img/timeline/New_Webpage.webp"></TimeCard>
                            </div>
                        </div>
                    </div>
                </div>
